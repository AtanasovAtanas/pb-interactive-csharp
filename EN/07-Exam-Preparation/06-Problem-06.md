...
[task-description]
# Description
It's Friday night and you're wondering which movie to watch. 
...
Points are calculated as the sum of the ASCII character values in the movie title. (There will not be a case where we have two films with an equal number of points)
...
- Similarly, we proceed with each subsequent letter and receive an amount of 563.
